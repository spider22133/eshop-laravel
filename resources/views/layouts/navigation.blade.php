{{--
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed z-20 top-0 w-full">
    ...
    <li class="relative px-6 py-3">
        ...
        <template x-if="isPagesMenuOpen">
            ...
            >
                ...
                >
                    <a class="w-full" href="/admin/products">All products</a>
                </li>
                <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
                    <a class="w-full" href="/admin/products/create">
                        Create product
                    </a>
                </li>
